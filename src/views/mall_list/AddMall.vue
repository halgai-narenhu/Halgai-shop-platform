      ...
      <a-form @submit="handleSubmit" :form="form">
        ...
        <a-form-item
          ...
          <a-input
            v-decorator="[
              'shopnum',
              {rules: [{ required: true, message: $t('请输入门店编号') }]}
            ]"
            name="shopnum"
            :placeholder="$t('达达、美团配送的时候需要填写')" />
        </a-form-item>
        <a-form-item
          :label="$t('生鲜配送')"
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
          ...
          <a-input
            v-decorator="[
              'shengxian',
              {rules: [{ required: true, message: $t('请输入生鲜配送') }]}
            ]"
            name="shengxian"
            :placeholder="$t('达达配送填 dada ,其他留空不要填写')" />
        </a-form-item>
        <a-form-item
          :label="$t('接单模式')"
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
          ...
          :required="false"
        >
          <a-radio-group v-decorator="['jiedan', { initialValue: 1 }]">
            <a-radio :value="1">{{ $t('需要商家确认') }}</a-radio>
            <a-radio :value="2">{{ $t('系统自动确认') }}</a-radio>
          </a-radio-group>
        </a-form-item>
        <a-form-item
          :label="$t('外卖模式')"
          ...
          :required="false"
        >
          <a-radio-group v-decorator="['waimai', { initialValue: 1 }]">
            <a-radio :value="1">{{ $t('开启') }}</a-radio>
        ...
        <a-form-item
          ...
          :required="false"
        >
          <a-radio-group v-decorator="['ziqu', { initialValue: 1 }]">
            <a-radio :value="1">{{ $t('开启') }}</a-radio>
            <a-radio :value="2">{{ $t('关闭') }}</a-radio>
          </a-radio-group>
        </a-form-item>
        <a-form-item
          ...
          :required="false"
        >
          <a-radio-group v-decorator="['diancan', { initialValue: 1 }]">
            <a-radio :value="1">{{ $t('开启') }}</a-radio>
            <a-radio :value="2">{{ $t('关闭') }}</a-radio>
          </a-radio-group>
        </a-form-item>
        <a-form-item
          ...
          :required="false"
        >
          <a-cascader :options="options" placeholder="- 请 选 择 -" @change="onChange" />
        </a-form-item>
        <a-form-item
          :label="$t('店铺名称')"
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
          ...
          <a-input
            ...
            name="shopname"
            :placeholder="$t('自定义店铺名称，32个字符以内')" />
        </a-form-item>
        <a-form-item
          :label="$t('服务距离')"
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
          :wrapperCol="{lg: {span: 10}, sm: {span: 17} }">
          <a-input type="number" addon-after="公里" default-value="mysite" />
        </a-form-item>
        <a-form-item
          :label="$t('起送金额')"
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
        ...
        <a-form-item
          ...
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
          :wrapperCol="{lg: {span: 10}, sm: {span: 17} }">
          <a-time-picker use12-hours />--<a-time-picker use12-hours />
        </a-form-item>
        <a-form-item
          :label="$t('地址')"
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
        ...
        <a-form-item
          ...
          <a-input
            ...
            v-decorator="[
              'dianhua',
              {rules: [{ required: true, message: $t('请输入电话') }]}
            ]"
            name="dianhua"
            :placeholder="$t('请填入电话号')" />
        </a-form-item>
        <a-form-item
          :label="$t('状态')"
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
